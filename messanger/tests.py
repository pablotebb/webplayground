...
class ThreadTestCase(TestCase):
  ...
  def test_add_users_to_thread(self):
    ...
    self.assertEqual(len(self.thread.users.all()), 2) # es decir, deberían de haber 2 usuarios dentro del hilo... 
  ...
  def test_add_message_from_user_not_in_thread(self):
    ...
    self.assertEqual(len(self.thread.messages.all()), 2) # AssertionError: 3 != 2
